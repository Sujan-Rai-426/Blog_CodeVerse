...
const Template_Preview = () => {
    ...
    // Scroll to Project Setup Guide Ref
    const set_up_guide_Ref = useRef(null);
    const ScrollToSetupguideSection = () => {
        set_up_guide_Ref.current?.scrollIntoView({behavior: 'smooth'})
    }
    ...
    return (
        <div className="template-preview-container">
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", padding: "0 0.5rem", alignItems: "center" }}>
                        ...
                        {/* *****************  SHARE + PROJECT setup Guide BUTTON ******************** */}
                            <div style={{ display: "flex", gap: '1rem', margin: "0.8rem 0" }}>
                                ...
                                <button className="download-guide bg-info" onClick={ScrollToSetupguideSection}>
                                    Project Setup Guide
                                </button>
                        </div>
                    </div>
            ...
            {/* Preview iframe Section */}
                ...
                <div ref={set_up_guide_Ref} style={{ scrollMarginTop: '80px' }} className="run-instructions">
