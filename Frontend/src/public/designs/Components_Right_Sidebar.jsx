        ...
        {/* ==== Extra Actions ==== */}
            <div className="sidebar-section extra-actions">
                ...
                <div className="actions-list">
                    ...
                    {/* Visite Developer Site */}
                        <button 
                            title="Developer site" 
                            onClick={() => window.open(
                                "https://er-sujan.vercel.app","_blank"
                            )}
                        >
                            <span className="crs-BuyMeCoffee-icon"><FaUserPlus /></span> Developer Site
                        </button>
                    ...
                    {/* Test Your Code */}
                        ...
                        >
                            <span className="text-info crs-requestFeature-icon"><FaCode /></span> &nbsp; Code Compiler
                        </button>
                    ...
                    {/* Generate Your Code */}
                        <button 
                            title='Generate Code'
                            onClick={() => navigate("/PlayGround/Code-Generator")} 
                        >
                            <span className="text-info crs-requestFeature-icon"><FaFileCode /></span> &nbsp; Code Generator
                        </button>
