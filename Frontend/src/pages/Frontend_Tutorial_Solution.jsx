...
// // VIDEO CARD COMPONENT (with CopyButton inside)
...
//   // Track which tabs have completed ads
...
//         setAdCompleted((prev) => {
//             if (prev[tab]) return prev; // avoid redundant updates
...
//     // Prism highlight after ad completes
//     useEffect(() => {
...
//   //  CopyButton moved INSIDE VideoCard
...
//                             {/* Copy Button Disabled While Ads Running */}
