...
const PlayGround_Code_Compiler = () => {
    ...
    // Initial content if nothing is in localStorage
            ...
            <main className="cv-main">
                <section className="editor-section">
                    ...
                    <div className="editor-area">
                        {activeTab === 'html' && <textarea value={html} onChange={(e) => setHtml(e.target.value)} onKeyDown={handleTabKeyDown} spellCheck="false" placeholder="Enter HTML here..." />}
                        {activeTab === 'css' && <textarea value={css} onChange={(e) => setCss(e.target.value)} onKeyDown={handleTabKeyDown} spellCheck="false" placeholder="Enter CSS here..." />}
                        {activeTab === 'js' && <textarea value={js} onChange={(e) => setJs(e.target.value)} onKeyDown={handleTabKeyDown} spellCheck="false" placeholder="Enter JS here..." />}
                    </div>
                </section>
                ...
                <section className="preview-section">
                    <div className="browser-mock">
                        <div className="browser-head">
                            ...
                            <div className="url-bar">https://codevora140.vercel.app/Code-to-Preview</div>
                        </div>
