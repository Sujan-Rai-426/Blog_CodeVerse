...
//   const formInputStyle = { width: "100%" };
...
//     fetchResource("topic");
//     fetchResource("designs");
//     fetchResource("code-guides");
//     fetchResource("template");
//   }, [fetchResource]);

//   // ------------------ Derived state from cache ------------------
//   const allCategories = getCached("category").data || [];
//   const allLanguages = getCached("language").data || [];
//   const allTopics = getCached("topic").data || [];
//   const frontendDesignLanguages = getCached("language").data?.filter((l) => l.section === "Frontend") || [];
//   const frontendDesigns = getCached("topic").data?.filter((t) => t.language === frontendDesignLanguage) || [];
//   const codeGuideLanguages = allLanguages.filter((l) => l.section === "Backend") || [];
//   const codingGuides = allTopics.filter((t) => t.language === codeGuideLanguage) || [];
//   const allTemplateTypes = getCached("template-type").data || [];
...
//   setIsUploading(true);
//   try {
//     const created = await createResource("category", { name: categoryName });

//     // Update cache immediately
//     updateCacheList("category", created);
...
//   setIsUploading(true);
//   try {
//     const created = await createResource("language", {
//       name: languageName,
//       icon,
//       section: sectionType,
//       category: categoryId,
...
//     // Update cache immediately
//     updateCacheList("language", created);

//     // Reset form
//     setLanguageName("");
//     setIcon("");
//     setCategoryId("");
//     setSectionType("Frontend");
//   } finally {
//     setIsUploading(false);
//   }
// };
...
//   setIsUploading(true);
//   try {
//     const created = await createResource("topic", {
//       name: topicName,
//       language: topicLanguage,
//     });

//     // Update cache immediately
//     updateCacheList("topic", created);
...
//       access_type: sourceAccessType,
//       price: sourcePrice,
//       language: frontendDesignLanguage,
//       topic: frontendTopic,
//     };

//     const created = await createResource("designs", payload);

//     // Update cache immediately
//     updateCacheList("designs", created);
...
//   try {
//     const formData = new FormData();
//     formData.append("language", codeGuideLanguage);
//     formData.append("topic", backendTopic);
//     formData.append("step_number", stepNumber);
//     formData.append("step_file_name", stepFileName);
//     formData.append("description", stepDescription);
//     formData.append("code", stepCode);
//     if (imageFile) formData.append("image", imageFile);

//     const created = await createResource("code-guides", formData);

//     // Update cache immediately
//     updateCacheList("code-guides", created);
...
//     const created = await createResource("template", payload);

//     // Update cache immediately
//     updateCacheList("template", created);
...
// // ----- DERIVED OCCUPIED STEPS FOR BACKEND -----
// const occupiedSteps = getCached("code-guides").data
//   ?.filter(s => s.topic === backendTopic)
//   .map(s => s.step_number) || [];



//   // You can similarly wrap other forms (designs, code-guides, template) using `createResource` + `isUploading`
