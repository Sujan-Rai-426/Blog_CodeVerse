                  ...
                  <div key={tpl.id} className="avd-sub-card">
                    {editingId === tpl.id ? (
                      <>
                        ...
                        <input
                          type="text"
                          className="avd-input text-secondary"
                          value={formData.title || ""}
                          onChange={(e) =>
                        ...
                        <textarea
                          className="avd-textarea text-secondary"
                        ...
                        <select
                          className="avd-input text-primary"
                      ...
                      <>
                        ...
                        <p className="text-gray">
                          ...
                          |{" "}
                          {tpl.documentation && (
                            <a href={tpl.documentation_url} target="_blank" rel="noreferrer">
                              Docs
                            </a>
                          )}
                          {tpl.github_repo_url && (
                            <a href={tpl.github_repo_url} target="_blank" rel="noreferrer">
                              GitHub Repo ⭐
                            </a>
                          )}
                        </p>
